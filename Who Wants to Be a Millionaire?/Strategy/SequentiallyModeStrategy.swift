//
//  SequentiallyModeStrategy.swift
...
final class SequentiallyModeStrategy: GameStrategy {
    ...
    func getNewQuestion(view: GameView) {
        ...
        let nextQuestion = gameSession.defaultQuestionStorage[gameSession.currentQuestionIndex.value]
